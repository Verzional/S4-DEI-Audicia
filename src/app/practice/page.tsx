  ...
  return (
    <div className="mb-8">
      ...
      <div
        ...
        id="chat-area"
        className="chat-area border border-gray-200 rounded-lg p-6 mb-4 min-h-[400px] max-h-[400px] overflow-y-auto flex flex-col"
      >
        ...
        <div className="flex mb-4">
          ...
          <div className="ai-chat-bubble bg-gray-100 p-4 rounded-lg max-w-[80%]">
            <p>
              Halo! Saya adalah pewawancara AI Anda hari ini. Kami sedang
              mencari kandidat yang cocok dengan perusahaan kami dan memiliki
              keterampilan yang kami butuhkan. Mari kita mulai dengan pertanyaan
              umum: Bisakah Anda ceritakan sedikit tentang diri Anda dan mengapa
        ...
        {messages.map((msg, index) => (
          ...
          >
            ...
            <div
              className={`${
                msg.sender === "user"
                  ? "user-chat-bubble bg-light-orange text-right"
      ...
      <div className="relative">
        <div className="flex items-center border border-gray-200 rounded-lg">
          <button
            ...
            } rounded-l-lg hover:bg-green-600`}
        ...
        <div
          ...
          className={`voice-recognition ${
            isListening ? "" : "hidden"
          } bg-gray-100 mt-4 p-4 rounded-lg`}
        >
          <h3 className="font-medium mb-1">Pengenalan Suara Aktif</h3>
          <p className="text-gray-600 text-sm">
            Bicaralah dengan jelas ke mikrofon Anda. Suara Anda akan
            ditranskripsikan di sini.
          </p>
        </div>
      </div>
    </div>
